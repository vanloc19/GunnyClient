package bagAndInfo.bag
{
   ...
   public class BankBagView extends BagView
   {
      ...
      private var _bank:bagAndInfo.bag.BankBagListView;
      ...
      override protected function initBackGround() : void
      {
         ...
         this._bank = new bagAndInfo.bag.BankBagListView(51);
      ...
      override protected function __cellDoubleClick(param1:CellEvent) : void
      {
         ...
         if(!_loc3_.locked)
         {
            SocketManager.Instance.out.sendMoveGoods(_loc4_.BagType,_loc4_.Place,51,-1);
         }
      }
      ...
      {
         if(Boolean(param1) && (param1.CategoryID == 10 || param1.CategoryID == 11 || param1.CategoryID == 12 || param1.CategoryID == 20 || param1.CategoryID == 23))
         {
            return 1;
         }
         return 0;
      ...
      private function __frameEvent(param1:FrameEvent) : void
      {
         ...
         _loc2_.removeEventListener("response",this.__frameEvent);
         _loc2_.dispose();
         var _loc3_:BagInfo = PlayerManager.Instance.Self.getBag(51);
         switch(int(param1.responseCode))
         {
            case 0:
            case 1:
               PlayerManager.Instance.Self.PropBag.sortBag(3,_loc3_,0,_loc3_.items.length,false);
               break;
            case 2:
            case 3:
            case 4:
               PlayerManager.Instance.Self.PropBag.sortBag(3,_loc3_,0,_loc3_.items.length,true);
         }
      }
