         ...
         if(Boolean(_loc3_) && param1.action != DragEffect.SPLIT)
         {
            ...
            else
            {
               ...
               if(_loc3_.CanEquip)
               {
                  ...
                  else if(_loc3_.RefineryLevel > 0 && _cells[this._stonePlace].itemInfo.Property1 == "35" || _loc3_.RefineryLevel == 0 && _cells[this._stonePlace].itemInfo.Property1 == StoneType.STRENGTH)
                  {
                     _cells[2].dragDrop(param1);
                     this.reset();
                  }
               ...
               else if(_cells[2].itemInfo.RefineryLevel > 0 && _loc3_.Property1 == "35" || _cells[2].itemInfo.RefineryLevel == 0 && _loc3_.Property1 == StoneType.STRENGTH)
               {
                  if(!this._hasStone)
                  {
                  ...
                  else if(_cells[this._stonePlace].itemInfo.Property1 == _loc3_.Property1)
                  {
                     this.findCellAndDrop();
                     this.reset();
                  }
