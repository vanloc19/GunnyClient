package store.view.strength
{
   ...
   public class StoreIIStrengthBG extends Sprite implements IStoreViewBG
   {
      ...
      private var _consortiaSmith:store.view.strength.MySmithLevel;
      ...
      private var _sBuyGiftBag:store.view.strength.BuyGiftBagButton;
      
      private var _spellAlertFrame:store.view.strength.SpellAlertFrame;
      ...
      private function init() : void
      {
         ...
         this._strthShine.mouseChildren = this._strthShine.mouseEnabled = false;
         ...
         while(_loc2_ < 6)
         {
            ...
            {
               _loc1_ = new StrengthStone([StoneType.STRENGTH,StoneType.STRENGTH_1],_loc2_);
            }
            else if(_loc2_ == 4)
            {
               _loc1_ = new StoneCell([StoneType.LUCKY],_loc2_);
            }
            else if(_loc2_ == 3)
            {
               _loc1_ = new StoneCell([StoneType.SOULSYMBOL],_loc2_);
            }
            else if(_loc2_ == 5)
            {
               _loc1_ = new StreangthItemCell(_loc2_);
            }
         ...
         var _loc3_:String = LanguageMgr.GetTranslation("store.StoreIIComposeBG.StrengthenStonStrip");
         ...
         var _loc6_:String = LanguageMgr.GetTranslation("store.StoreIIComposeBG.VIPAddStrip");
         var _loc7_:String = LanguageMgr.GetTranslation("store.StoreIIComposeBG.AllNumStrip");
         ...
         {
            _loc6_ = LanguageMgr.GetTranslation("store.StoreIIComposeBG.NoVIPAddStrip");
         }
         this._showSuccessRate.showAllTips(_loc3_,_loc4_,_loc5_,_loc7_);
         this._showSuccessRate.showVIPTip(_loc6_);
      ...
      private function getCellsPoint() : void
      {
         ...
         while(_loc2_ < 6)
         {
            _loc1_ = ComponentFactory.Instance.creatCustomObject("store.Strengthpoint" + _loc2_);
      ...
      public function dragDrop(param1:BagCell) : void
      {
         ...
         for each(_loc2_ in this._items)
         {
            if(_loc2_)
            {
               ...
               else if(_loc2_ is StreangthItemCell)
               {
                  ...
                  {
                     if(_loc4_.StrengthenLevel >= PathManager.solveStrengthMax())
                     {
                     ...
                     {
                        if(_loc4_.StrengthenLevel == 9 && !SharedManager.Instance.isAffirm)
                        {
         ...
         if(EquipType.isStrengthStone(_loc4_) || _loc4_.CategoryID == 11 && _loc4_.Property1 == StoneType.SOULSYMBOL || _loc4_.CategoryID == 11 && _loc4_.Property1 == StoneType.LUCKY)
         {
            for each(_loc2_ in this._items)
            {
               if(_loc2_ is StoneCell && (_loc2_ as StoneCell).types.indexOf(_loc4_.Property1) > -1 && _loc4_.CategoryID == 11)
               {
                  if(this.isAdaptToStone(_loc4_))
                  {
                     SocketManager.Instance.out.sendMoveGoods(_loc4_.BagType,_loc4_.Place,BagInfo.STOREBAG,_loc2_.index,1);
      ...
      private function __strengthClick(param1:MouseEvent) : void
      {
         ...
         if(this._items[5].info != null)
         {
            ...
            if(this._items[5].itemInfo.StrengthenLevel > 5 && this._items[3].info == null)
            {
               ...
               this._spellAlertFrame.addEventListener(store.view.strength.SpellAlertFrame.CLOSE,this.__spellAlertClose);
               this._spellAlertFrame.addEventListener(store.view.strength.SpellAlertFrame.SUBMIT,this.__spellAlertSubmit);
               return;
            }
         }
      ...
      {
         this._spellAlertFrame.removeEventListener(store.view.strength.SpellAlertFrame.CLOSE,this.__spellAlertClose);
         this._spellAlertFrame.removeEventListener(store.view.strength.SpellAlertFrame.SUBMIT,this.__spellAlertSubmit);
      ...
      private function __fiveLevelResponse(param1:FrameEvent) : void
      {
         ...
         _loc3_.removeEventListener(FrameEvent.RESPONSE,this.__fiveLevelResponse);
      ...
      private function __graceResponse(param1:FrameEvent) : void
      {
         ...
         SoundManager.instance.play("008");
         var _loc3_:BaseAlerFrame = param1.currentTarget as BaseAlerFrame;
         _loc3_.removeEventListener(FrameEvent.RESPONSE,this.__graceResponse);
         ObjectUtils.disposeObject(param1.target);
         if(param1.responseCode == FrameEvent.SUBMIT_CLICK || param1.responseCode == FrameEvent.ENTER_CLICK)
         {
            if(this.checkTipBindType())
