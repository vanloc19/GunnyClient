package store.view
{
   ...
   public class ConsortiaRateManager extends EventDispatcher
   {
      ...
      public static var _instance:store.view.ConsortiaRateManager;
      ...
      public static function get instance() : store.view.ConsortiaRateManager
      {
         if(_instance == null)
         {
            _instance = new store.view.ConsortiaRateManager();
         }
         return _instance;
      }
      ...
      {
         var _loc2_:ConsortiaAssetLevelOffer = null;
         var _loc3_:int = int(param1.useConditionList.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            ...
            if(_loc2_.Type == 2)
            {
               this.setStripTipDataRichs(_loc2_.Riches);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(Boolean(param1.changedProperties["SmithLevel"]))
         {
            this._SmithLevel = PlayerManager.Instance.Self.consortiaInfo.SmithLevel;
         }
         if(Boolean(param1.changedProperties["RichesOffer"]) || Boolean(param1.changedProperties["RichesRob"]))
         {
            this._selfRich = PlayerManager.Instance.Self.RichesOffer + PlayerManager.Instance.Self.RichesRob;
         }
         this._rate = this._SmithLevel;
