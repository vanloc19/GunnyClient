package store.data
{
   ...
   public class StoreEquipExperience
   {
      ...
      public static var NECKLACE_MAX_LEVEL:int = 100;
      ...
      {
         if(necklaceStrengthPlusList != null && necklaceStrengthPlusList.hasOwnProperty(param1))
         {
      ...
      {
         if(necklaceStrengthExpList == null)
         {
            return 1;
         }
         ...
         while(_loc2_ > -1)
         {
            if(necklaceStrengthExpList.hasOwnProperty(_loc2_) && necklaceStrengthExpList[_loc2_] <= param1)
            {
               return _loc2_;
            }
            _loc2_--;
      ...
      public static function getNecklaceExpMax(param1:int) : int
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ <= NECKLACE_MAX_LEVEL)
         {
            if(necklaceStrengthExpList.hasOwnProperty(_loc2_) && necklaceStrengthExpList[_loc2_] > param1)
            {
               return necklaceStrengthExpList[_loc2_];
            }
            _loc2_++;
         }
         if(necklaceStrengthExpList.hasOwnProperty(NECKLACE_MAX_LEVEL))
         {
            return necklaceStrengthExpList[NECKLACE_MAX_LEVEL];
         }
         return param1;
      }
      ...
      public static function getNecklaceCurrentlevelExp(param1:int) : int
      {
         ...
         if(necklaceStrengthExpList.hasOwnProperty(_loc2_))
         {
      ...
      public static function getNecklaceCurrentlevelMaxExp(param1:int) : int
      {
         ...
         if(param1 < NECKLACE_MAX_LEVEL && necklaceStrengthExpList.hasOwnProperty(param1 + 1) && necklaceStrengthExpList.hasOwnProperty(param1))
         {
            return necklaceStrengthExpList[param1 + 1] - necklaceStrengthExpList[param1];
         }
         if(necklaceStrengthExpList.hasOwnProperty(param1) && necklaceStrengthExpList.hasOwnProperty(param1 - 1))
         {
