package store
{
   ...
   public class FineBringUpController extends EventDispatcher
   {
      ...
      private static var instance:store.FineBringUpController;
      ...
      public static function getInstance() : store.FineBringUpController
      {
         if(!instance)
         {
            instance = new store.FineBringUpController(new inner());
         }
         return instance;
      }
      ...
      private function sendEat() : void
      {
         ...
         {
            _loc1_ = new Array();
            _loc2_ = int(this.expData.placeArr.length);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
