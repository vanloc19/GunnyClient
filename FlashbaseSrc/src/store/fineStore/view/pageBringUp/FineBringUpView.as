package store.fineStore.view.pageBringUp
{
   ...
   public class FineBringUpView extends Sprite implements Disposeable, IObserver
   {
      ...
      private var _bringUpItemCell:store.fineStore.view.pageBringUp.FineBringUpCell;
      
      private var _bagList:store.fineStore.view.pageBringUp.FineBringUpBagListView;
      
      private var _rightDrapSprite:store.fineStore.view.pageBringUp.FineBringUpRightDragSprite;
      
      private var _leftDrapSprite:store.fineStore.view.pageBringUp.FineBringUpLeftDragSprite;
      ...
      private function initView() : void
      {
         ...
         this._bagList = new store.fineStore.view.pageBringUp.FineBringUpBagListView(BagInfo.EQUIPBAG,7,63);
         ...
         this._bringUpItemCell = new store.fineStore.view.pageBringUp.FineBringUpCell(0);
      ...
      {
         if(Boolean(param1.changedProperties["Money"]) || Boolean(param1.changedProperties["Gold"]) || Boolean(param1.changedProperties["Gift"]) || Boolean(param1.changedProperties["medal"]))
         {
            this.updateMoney();
         }
      }
      ...
      {
         var expData:Array;
         var buyView:BuySingleGoodsView;
         ...
         expData = FineBringUpController.getInstance().expDataArr(this._bringUpItemCell.info);
         if(expData[1] == 0)
         {
         ...
         buyView = new BuySingleGoodsView();
      ...
      {
         this._leftDrapSprite = new store.fineStore.view.pageBringUp.FineBringUpLeftDragSprite();
         ...
         this._rightDrapSprite = new store.fineStore.view.pageBringUp.FineBringUpRightDragSprite();
      ...
      private function equipChangeHandler(param1:Event) : void
      {
         ...
         if(Boolean(this._bringUpItemCell.info))
         {
