                    ...
                    @foreach($serverList as $server)
                        @switch($server->Status)
                            ...
                            <div class="box tb-box">
                                ...
                                <div>
                                    <a class="btn-select-server btn-select-server-stable" href="{{route('view-play-game', $server->ServerID)}}">
                                        {{$server->ServerName}}
                                    </a>
                                </div>
                            </div>
...
{{--                                    <div class="row">--}}
                                        <div class="col-6 col-sm-3 p-0 tb-box-bottom">
                                            <a href="{{route('view-play-game', $server->ServerID)}}" class="btn-select-server btn-select-server-stable">
                                                {{$server->ServerName}}
                                            </a>
                                        </div>
{{--                                    </div>--}}
