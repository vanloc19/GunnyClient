<div class="play-game btn-login p-a js-btn-login">
    <a href="#" class="playGame_btn " target="_blank"></a>
</div>
<div id="login">
    ...
    <div class="clearfix">
        <div style="float: left; max-width: 70%; line-height: 1; overflow: hidden;">
            <p
                style="font-size: 35px; color: #555; display: flex;flex-direction: column;align-items: flex-start;justify-content: flex-end;">
                ...
                <img style="margin: 0;"
                    src="/assets/img/vip/vip{{Auth::guard('member')->user()->getVipLevel()}}_small.png" />
            </p>
    ...
    @endif
    <input class="animElement slide-left time-300" id="usernamelogin" placeholder="Tài Khoản" autocomplete="off">
    <input class="animElement slide-left time-300" id="passwordlogin" type="password" placeholder="Mật Khẩu"
    ...
    {{--            <a style="font-weight: bold" class="animElement just-show" href="{{route('view-transfer-account')}}">CẬP
    NHẬP TÀI KHOẢN</a>--}}
    {{--        </div>--}}
    <div class="footer" style="display: flex">
        <a style="font-weight: bold" class="animElement just-show" href="{{route('view-login-puffin')}}">ĐĂNG NHẬP
            PUFFIN IOS</a>
    </div>
    @endguest
